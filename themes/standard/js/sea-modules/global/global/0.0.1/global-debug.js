define("global/global/0.0.1/index-debug", [ "jquery/jquery/1.10.1/jquery-debug", "./mod/file-debug" ], function(require, exports, module) {
...
define("global/global/0.0.1/mod/file-debug", [ "jquery/jquery/1.10.1/jquery-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    function File(bid) {
...
define("global/global/0.0.1/batchUpload-debug", [ "jquery/jquery/1.10.1/jquery-debug", "./mod/batch-debug", "./lib/jqueryForm-debug", "./mod/selectWidget-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
...
define("global/global/0.0.1/mod/batch-debug", [ "jquery/jquery/1.10.1/jquery-debug", "global/global/0.0.1/lib/jqueryForm-debug", "global/global/0.0.1/mod/selectWidget-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
...
define("global/global/0.0.1/lib/jqueryForm-debug", [ "jquery/jquery/1.10.1/jquery-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    (function($) {
        "use strict";
        /*
...
define("global/global/0.0.1/mod/selectWidget-debug", [ "jquery/jquery/1.10.1/jquery-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    //js模拟下拉框
...
define("global/global/0.0.1/browse-debug", [ "jquery/jquery/1.10.1/jquery-debug", "./mod/selectWidget-debug", "./mod/inputVal-debug", "./mod/formCheck-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    //下拉框
    ...
    //关键字搜索输入框
    var InputVal = require("./mod/inputVal-debug");
    var sbkey = new InputVal('input[name="sbkey"]', "请输入关键字");
    sbkey.init();
    //表单验证
    var fc = require("./mod/formCheck-debug");
...
//输入框友好提示
define("global/global/0.0.1/mod/inputVal-debug", [ "jquery/jquery/1.10.1/jquery-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
...
//表单验证
define("global/global/0.0.1/mod/formCheck-debug", [ "jquery/jquery/1.10.1/jquery-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
...
define("global/global/0.0.1/forgetPwd-debug", [ "jquery/jquery/1.10.1/jquery-debug", "./mod/verify-debug", "./lib/jqueryForm-debug", "./mod/getParam-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    ...
    var gp = require("./mod/getParam-debug");
...
// JavaScript Document
define("global/global/0.0.1/mod/verify-debug", [ "jquery/jquery/1.10.1/jquery-debug", "global/global/0.0.1/lib/jqueryForm-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    require("global/global/0.0.1/lib/jqueryForm-debug");
    function Verify() {
...
define("global/global/0.0.1/mod/getParam-debug", [], function(require, exports, module) {
...
define("global/global/0.0.1/login-debug", [ "jquery/jquery/1.10.1/jquery-debug", "./mod/verify-debug", "./lib/jqueryForm-debug", "./mod/getParam-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    var Verify = require("./mod/verify-debug");
    var ve = new Verify();
    $('input[name="name"]').blur(function() {
...
define("global/global/0.0.1/register-debug", [ "jquery/jquery/1.10.1/jquery-debug", "./mod/verify-debug", "./lib/jqueryForm-debug", "./mod/getParam-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    var Verify = require("./mod/verify-debug");
    var ve = new Verify();
    $('input[name="name"]').blur(function() {
...
define("global/global/0.0.1/upload-debug", [ "jquery/jquery/1.10.1/jquery-debug", "./mod/verifyAtta-debug", "./lib/jqueryForm-debug", "./mod/selectWidget-debug", "./mod/formCheck-debug" ], function(require, exports, modulselectWidgete) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    ...
    //选择文件后验证上传到temp目录中
    var VerifyAtta = require("./mod/verifyAtta-debug");
    ...
    //上传和编辑页面表单验证
    var FormCheck = require("./mod/formCheck-debug");
...
define("global/global/0.0.1/mod/verifyAtta-debug", [ "jquery/jquery/1.10.1/jquery-debug", "global/global/0.0.1/lib/jqueryForm-debug" ], function(require, exports, module) {
    var $ = require("jquery/jquery/1.10.1/jquery-debug");
    require("global/global/0.0.1/lib/jqueryForm-debug");
    function VerifyAtta() {}
